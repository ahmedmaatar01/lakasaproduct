                ...
                <div class="row">
                    ...
                    <div class="  col-lg-6 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="prix_metre_carre"
                            name="prix_metre_carre" value="{{ $product->prix_metre_carre }}" required>
                    </div>
                    ...
                    <div class=" col-lg-12 d-flex mb-3 ">
                        <label class="custom-control custom-checkbox-md me-5">
                            <input type="checkbox" class="custom-control-input" name="interrepteur" value="interrepteur"
                                @if ($product->interrepteur == '1') checked="" @endif>
                        ...
                        <label class="custom-control custom-checkbox-md">
                            <input type="checkbox" class="custom-control-input" name="led" value="led"
                                @if ($product->led == '1') checked="" @endif>
                        ...
                        <select class="form-select" id="product_details_id" name="product_details_id" required>
                            @foreach ($details as $detail)
                                <option value="{{ $detail->id }}"
                                    {{ $product->product_details_id == $detail->id ? 'selected' : '' }}>
                                    {{ $detail->name }}</option>
                            @endforeach
                        </select>
                    </div>
