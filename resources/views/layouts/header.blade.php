    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                <img src="{{ asset('template-sash/images/brand/logo.png') }}" class="header-brand-img desktop-logo" style="max-width:50%; max-height: 50px;" alt="logo">
                <img src="{{ asset('template-sash/images/brand/logo-3.png') }}" class="header-brand-img light-logo1"style="max-width:50%; max-height: 50px;" 
                    alt="logo">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                                    ...
                                    <div class="header-dropdown-list message-menu">
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                ...
                                                data-bs-image-src="{{ asset('template-sash/images/pngs/4.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template-sash/images/pngs/6.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template-sash/images/pngs/8.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template-sash/images/pngs/1.jpg') }}"></span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span
                                                class="avatar avatar-xl br-5 me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template-sash/images/pngs/3.jpg') }}"></span>
                                            <div class="wd-50p">
                                    ...
                                    <div class="message-menu message-menu-scroll">
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                ...
                                                data-bs-image-src="{{ asset('template-sash/images/users/1.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template-sash/images/users/15.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template-sash/images/users/12.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template-sash/images/users/4.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.html">
                                            <span
                                                class="avatar avatar-md brround me-3 align-self-center cover-image"
                                                data-bs-image-src="{{ asset('template-sash/images/users/3.jpg') }}"></span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                    <img src="{{ asset('template-sash/images/users/21.jpg') }}" alt="profile-user"
