    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="index.html">
                <img src="/template-sash/images/brand/logo.png" class="header-brand-img desktop-logo" style="max-width:50%;" alt="logo">
                <img src="/template-sash/images/brand/logo-1.png" class="header-brand-img toggle-logo" style="max-width:50%;"
                    alt="logo">
                <img src="/template-sash/images/brand/logo-2.png" class="header-brand-img light-logo" style="max-width:50%;" alt="logo">
                <img src="/template-sash/images/brand/logo-3.png" class="header-brand-img light-logo1" style="max-width:50%;"
                    alt="logo">
            </a>
            <!-- LOGO -->
        </div>
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                {{-- <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('medecin.index') }}"><i
                            class="side-menu__icon fa fa-user-md"></i><span
                            class="side-menu__label">Medecins</span></a>
                </li> --}}
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('categories.index') }}"><i
                            class="side-menu__icon fa fa-user-circle"></i><span
                            class="side-menu__label">Categories</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('products.index') }}"><i
                            class="side-menu__icon fa fa-user-circle"></i><span
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('home_page.edit') }}"><i
                            class="side-menu__icon fe fe-users"></i><span 
                            class="side-menu__label">Modifier Page Acceuil</span></a>
                </li>
                {{-- <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="#"><i
                            class="side-menu__icon fa fa-comment"></i><span
                            class="side-menu__label">Questions</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="#"><i
                            class="side-menu__icon fa fa-comment-o"></i><span
                            class="side-menu__label">Maladies</span></a>
                </li> --}}
                {{-- <li class="slide">
