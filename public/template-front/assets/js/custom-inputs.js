(function($) {
    ...
    $.fn.mySelectDropdown = function(options) {
        return this.each(function() {
            ...
            $this.each(function() {
                ...
                var label = $('<span tabindex="0" />').append($('<span />').text($(this)
                    .attr("placeholder"))).insertAfter($(this));
                var list = $("<ul />");
            ...
            if (!$(this).is(":disabled")) {
                $(this).parent().on("click", "ul li a", function(e) {
                    ...
                    var label = active ? $("<span />").text(dropdown.find("select").attr(
    ...
    function onKeyDown(e) {
        ...
        var $dropdownDiv = focused ? $span.closest(".selectDropdown") :
            false; //getDropdownDivBasedOnMousePosition();
